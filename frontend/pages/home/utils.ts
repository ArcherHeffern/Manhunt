...
export function addJoinGameListener(navigation: homeProps['navigation'], io: SOCKET, setGame: React.Dispatch<React.SetStateAction<Game>>, setErrorMessage: React.Dispatch<React.SetStateAction<string>>, closeModal: () => void, setGameCode: React.Dispatch<React.SetStateAction<string>>) {
