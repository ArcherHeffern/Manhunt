...
[Tools Workflows and Extensions](https://docs.expo.dev/develop/development-builds/development-workflows/#build-locally-with-android-studio-and-xcode)
How late night archer was running the app god this takes forever maybe I should read the docs or smthing: 
```bash
npx expo:ios # to run on simulator
npx expo:ios -d # to run on connected device
```

Cleaning everything: expo prebuild --clean

Running on android
--
[docs](https://docs.expo.dev/workflow/android-studio-emulator/)
/Users/archerheffern/Library/Android/sdk